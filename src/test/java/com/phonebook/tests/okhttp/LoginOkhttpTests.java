...
public class LoginOkhttpTests {
    ...
    public void loginSuccess() throws IOException {
        AuthRequestDto auth = AuthRequestDto.builder().username("steve@gmail.com").password("Steve1234$").build();
    ...
    public void loginWithWrongEmail() throws IOException {
        ...
        AuthRequestDto auth = AuthRequestDto.builder().username("stevegmail.com").password("Steve1234$").build();
        RequestBody body = RequestBody.create(gson.toJson(auth), JSON);
